  ...
  form.addEventListener('submit', async (e) => {
    ...
    try {
      ...
      if (result.success && result.data && result.data.recommendations) {
        ...
        showStatus(result.message || "No matches found. Try relaxing your constraints.", "status-fallback");
      } else {
        showStatus(result.error || "An unknown error occurred.", "status-error");
      }
    } catch (err) {
